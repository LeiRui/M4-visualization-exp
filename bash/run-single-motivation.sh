...
$HOME_PATH/tool.sh enable_seq_space_compaction false ../../iotdb-engine-example.properties
$HOME_PATH/tool.sh enable_unseq_space_compaction false ../../iotdb-engine-example.properties
$HOME_PATH/tool.sh enable_cross_space_compaction false ../../iotdb-engine-example.properties
...
sleep 8s
# Usage: java -jar WriteData-*.jar device measurement dataType timestamp_precision total_time_length total_point_number iotdb_chunk_point_size filePath deleteFreq deleteLen timeIdx valueIdx VALUE_ENCODING
