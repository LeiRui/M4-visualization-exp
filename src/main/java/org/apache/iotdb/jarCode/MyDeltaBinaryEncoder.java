...
public abstract class MyDeltaBinaryEncoder extends Encoder {
   ...
   */
  public MyDeltaBinaryEncoder(int size) {
  ...
  public static class IntDeltaEncoder extends MyDeltaBinaryEncoder {
  ...
  public static class LongDeltaEncoder extends MyDeltaBinaryEncoder {
