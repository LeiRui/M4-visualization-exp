...
plt.savefig(os.environ['M4_VISUALIZATION_EXP']+"/more-baselines-DSSIM-exp/plot-{}-{}.png".format(read_method,os.environ['w']),bbox_inches='tight') #specify absolute fig path
end = time.time_ns()
