...
In these csv, counting from 0, the 8th column is the M4 aggregation query execution time of M4-UDF, and the 16th column is the M4 aggregation query execution time of M4-LSM.
