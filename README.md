...
```
java -jar BPlusTreeBaselineExp-jar-with-dependencies.jar true 1000 full-game/BallSpeed.csv
```
...
B+ tree index
on 1000 keys
data source file: full-game/BallSpeed.csv
...
```
java -jar BPlusTreeBaselineExp-jar-with-dependencies.jar false 1000 full-game/BallSpeed.csv
```
...
on 1000 keys
data source file is full-game/BallSpeed.csv
...
```
java -jar EvaluateChunkIndexFrontN-jar-with-dependencies.jar 10000000 full-game/BallSpeed.csv
```
